                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            ...
                                                            <img src="{{ asset($prod->image_product) }}" class="img-fluid"
                                                                style="height: 180px" alt="{{ $prod->name_product }}">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                    <li><a href="{{ $prod->slug_product }}"
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="{{ asset('images/img-pro-01.jpg') }}" class="img-fluid"
                                                            alt="Image">
                                                        <div class="mask-icon">
                                                            <ul>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-sm list-group-tree" id="list-group-men"
                                data-children=".sub-men">
                                @foreach ($cats as $cat)
                                    <a href="#" class="list-group-item list-group-item-action"> {{ $cat->name_category }}
                                    </a>
