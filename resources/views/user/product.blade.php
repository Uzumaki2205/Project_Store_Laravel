                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                <div class="row">
                                    ...
                                    @if ($prod->promotion->price_promotion > 0)
                                            ...
                                            <div class="box-img-hover">
                                                ...
                                                <div class="mask-icon">
                                                    ...
                                                    <form method="POST" action="{{ route('AddToCart') }}">
                                                        ...
                                                        <a class="cart"><button style="color:white;background-color: transparent; border: none;" type="submit">Thêm vào
                                                                giỏ</button></a>
                                                    </form>
                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            ...
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a>
                                                            </li>
            ...
            <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                <div class="product-categori">
                    ...
                    <div class="filter-sidebar-left">
                        ...
                        <div class="list-group list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            @foreach ($cats as $cat)
                            <a href="{{ route('search_category', ['id_category' => $cat->id]) }}" class="list-group-item list-group-item-action"> {{ $cat->name_category }}
                            </a>
