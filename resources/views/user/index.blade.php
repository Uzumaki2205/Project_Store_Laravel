                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="m-b-40">Bạn có thể trải nghiệm mua hàng nông sản trực tuyến <br> qua internet giúp
                                tiết kiệm thời gian và chi phí.</p>
                            <p><a class="btn hvr-hover" href="#">Bắt đầu mua sắm</a></p>
                        </div>
                    </div>
                </div>
            </li>
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="{{ asset('/Assets/images/img-pro-01.jpg') }}" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="{{ url('/Assets/images/blog-img.jpg') }}" alt="" />
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="{{ url('/Assets/images/blog-img-02.jpg') }} " alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Fusce in augue non nisi fringilla</h3>
